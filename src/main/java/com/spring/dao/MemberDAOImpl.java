...
public class MemberDAOImpl implements MemberDAO {
	...
	public List<MemberVO> selectMemberList() throws SQLException {
		List<MemberVO> memberList = sqlSession
				.selectList("Member-Mapper.selectMemberList", null);
		return memberList;
	}
	...
	public List<MemberVO> selectMemberList(SearchCriteria cri) throws SQLException {
		...
		memberList = sqlSession
				.selectList("Member-Mapper.selectSearchMemberList", cri, rowBounds);
	...
	public MemberVO selectMemberById(String id) throws SQLException {
		MemberVO memberVO = sqlSession.selectOne("Member-Mapper.selectMemberById", id);
		return memberVO;
	}
