...
public class ModifyEmployeeRequest {
	...
	private String posi_no;	//직위명
	private String dept_no;	//권한
	...
	public String toString() {
		return "ModifyEmployeeRequest [id=" + id + ", pwd=" + pwd + ", eno=" + eno + ", name=" + name + ", email="
				...
				+ ", regDate=" + regDate + ", picture=" + picture + ", old_picture=" + old_picture + ", posi_no="
				...
				+ ", old_licenseDoc=" + old_licenseDoc + ", old_garduDoc=" + old_graduDoc + ", old_scoreDoc="
