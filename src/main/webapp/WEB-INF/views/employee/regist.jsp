				...
				<div class="col-xs-8 col-sm-10" style="padding-left:0;">
					...
					<div class="form-group">
						...
						<div class="col-xs-8 col-sm-4 g_value">				
							<input class="col-sm-7" id="id" name="id" type="text" maxlength="20" required 
						...
						<div class="col-xs-8 col-sm-4 g_value">	
								<input class="col-sm-12" id="pwd" name="pwd" type="password" maxlength="20" required	
			...
			<div class="wrapper row">		
				<div class="col-sm-12">
					...
					<div class="form-group" >
						...
						<div class="col-xs-8 col-sm-4 g_value">
							<input type="text" id="eno" name="eno" placeholder="부서 및 입사날짜 선택 후 자동완성" style="text-align:center;width:100%;" readonly/>
						</div>
