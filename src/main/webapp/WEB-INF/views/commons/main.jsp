...
<script src="<%=request.getContextPath() %>/resources/js/vendor/what-input.js"></script>
<script src="<%=request.getContextPath() %>/resources/js/vendor/foundation.min.js"></script>
<script>
  $(document).foundation();
</script>
</body>
