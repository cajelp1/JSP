...
<script id="reply-template" type="text/x-handlebars-template">
	{{#each .}}
		<div class="itemdiv dialogdiv replyLi" data-rno={{rno}}>
			<div class="user">
				<img onerror="this.src='<%=request.getContextPath() %>/resources/images/avatar4.png'"
						src ="<%=request.getContextPath() %>/emplyee/picture/{{replyer}}">
			</div>
			<div class="body">
...
function reply_regist_go(){
	...
	$.ajax({
		...
		headers:{
			...
			"X-HTTP-Method-Override":"post"		<%--헤더의 메소드를 다르게 설정해줌--%>
		},
