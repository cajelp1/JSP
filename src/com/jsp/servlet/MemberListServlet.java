...
*/		
		...
		try {
			...
			System.out.println("페이지 번호 누락으로 1페이지로 돌아갑니다.");
		}
...
//			PageMaker a = (PageMaker)dataMap.get("pageMaker");
//			System.out.println(a.getCri().getPageStartRowNum());
//			System.out.println(a.getCri().getPerPageNum());
