			...
			<div class="card-body">
				<table class="table table-bordered text-center">
					...
					<c:forEach items="${dataMap.pdsList }" var="pds">
						<tr>
							<td>${pds.pno }</td>
							<td id="pdsTitle" style="text-align:left;max-width:100%; overflow:hidden; white-space:nowrap; text-overflow:elipsis;"> 
...
//		$('#jobForm input[name=keyword]').val($('.form-control input[name=keyword]').val());
//		$('#jobForm input[name=searchType]').val($('#searchType').val());
